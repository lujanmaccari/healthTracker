...
function Home() {
  return (
    <Container className="d-flex flex-column align-items-center mt-3 gap-3" style={{ maxWidth: '400px' }}>
  ...
  title="Actividad"
    body={
      <div className="d-flex justify-content-between text-center" style={{ fontSize: '0.9rem' }}>
        <div className="px-2">
  ...
  />
      ...
      <GenericCard
        title="Sueño"
        body={
          <div className="d-flex justify-content-around align-items-center px-2" style={{ gap: '1rem' }}>
